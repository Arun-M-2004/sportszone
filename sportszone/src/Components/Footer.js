      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} justifyContent="space-between">
          ...
          <Grid item xs={12} sm={2} className="footer-grid-item">
            ...
            <ul>
              ...
              <li><Link href="#" color="inherit" underline="none">Partner With Us</Link></li>
              <li><Link href="#" color="inherit" underline="none">Book Now</Link></li>
              <li><Link href="#" color="inherit" underline="none">News and Events</Link></li>
              <li><Link href="#" color="inherit" underline="none">Careers</Link></li>
              <li><Link href="#" color="inherit" underline="none">Blogs</Link></li>
            </ul>
          </Grid>
        ...
        <Box mt={4} className="footer-bottom">
          <Typography variant="body2">
            ...
            <Link href="https://www.softfruit.solutions/" color="inherit" underline="none">
              softfruit.solutions
            </Link> | Company Registered as Easycommune Online Services Private Ltd
          </Typography>
        </Box>
